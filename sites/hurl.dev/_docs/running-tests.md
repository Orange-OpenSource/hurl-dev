...
[`--report-json DIR`]: {% link _docs/manual.md %}#report-json
[`--report-junit FILE`]: {% link _docs/manual.md %}#report-junit
[`--report-tap FILE`]: {% link _docs/manual.md %}#report-tap
...
[`--error-format long` option]: {% link _docs/manual.md %}#error-format
