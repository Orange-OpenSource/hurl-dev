...
$ cat island.json | jq
[1;39m{
  [0m[1;34m"an emoji with UTF-8"[0m[1;39m: [0m[0;32m"🏝️"[0m[1;39m,
  [0m[1;34m"an emoji with Unicode escapes"[0m[1;39m: [0m[0;32m"🏝"[0m[1;39m
[1;39m}[0m
```
...
{
    [1;34m"an emoji with UTF-8"[0m: [33m"🏝️"[0m,
    [1;34m"an emoji with Unicode escapes"[0m: [33m"🏝"[0m
}
```
...
[1;39m{[0m
  [1;34m"an emoji with UTF-8"[0m[1;39m:[0m [0;32m"🏝️"[0m[1;39m,[0m
