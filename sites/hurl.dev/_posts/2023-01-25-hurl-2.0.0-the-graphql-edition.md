...
<p>
    <img class="light-img u-drop-shadow u-border" src="{{ '/assets/img/hurl-plus-graphql-light.png' | prepend:site.baseurl }}" width="100%" alt="Hurl plus GraphQL equals love" >
    <img class="dark-img u-drop-shadow u-border" src="{{ '/assets/img/hurl-plus-graphql-dark.png' | prepend:site.baseurl }}" width="100%" alt="Hurl plus GraphQL equals love" >
</p>
